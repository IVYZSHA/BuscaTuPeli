        ...
        public async Task<ActionResult> Post([FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                ...
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    // Aquí puedes guardar base64String en la base de datos o usarlo como necesites
                    pelicula.Poster = base64String; // Suponiendo que tienes una propiedad en tu DTO
                }
            }
        ...
        public async Task<ActionResult> Put(int id, [FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                ...
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    // Aquí puedes guardar base64String en la base de datos o usarlo como necesites
                    peliculaDB.Poster = base64String; // Suponiendo que tienes una propiedad en tu DTO
                }
            }
